...
// func (c *MenuController) GetCount(w http.ResponseWriter, r *http.Request, userID int64) error {
...
// func (c *MenuController) GetByID(w http.ResponseWriter, r *http.Request, userID int64) error {
// 	q := r.URL.Query()
...
// func (c *MenuController) GetPartially(w http.ResponseWriter, r *http.Request, userID int64) error {
// 	// offset, num
// 	q := r.URL.Query()
...
// // TODO: 一時的な実装です
// func (c *MenuController) Search(w http.ResponseWriter, r *http.Request, userID int64) error {
// 	q := r.URL.Query()
...
// func (c *MenuController) Post(w http.ResponseWriter, r *http.Request, userID int64) error {
// 	var body struct {
