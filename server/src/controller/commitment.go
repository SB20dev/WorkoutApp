...
// func (c *CommitmentController) GetTotalScore(w http.ResponseWriter, r *http.Request, userID int64) error {
...
// func (c *CommitmentController) GetCount(w http.ResponseWriter, r *http.Request, userID int64) error {
...
// func (c *CommitmentController) GetPartially(w http.ResponseWriter, r *http.Request, userID int64) error {
// 	// offset, num
// 	q := r.URL.Query()
...
// 	commitments, err := model.FetchCommitments(c.DB, userID, offset, num)
// 	if err != nil {
// 		helper.LogError(r, err, nil)
// 		return helper.CreateHTTPErrorWithCode(http.StatusInternalServerError, helper.FetchCommitmentsFailure)
// 	}
...
// func (c *CommitmentController) GetDetail(w http.ResponseWriter, r *http.Request, userID int64) error {
// 	q := r.URL.Query()
// 	commitment_id, err := strconv.ParseInt(q.Get("commitment_id"), 10, 64)
// 	if err != nil {
// 		helper.LogError(r, err, nil)
// 		return helper.CreateHTTPErrorWithCode(http.StatusBadRequest, helper.InvalidQueryParameter)
// 	}
...
// func (c *CommitmentController) Post(w http.ResponseWriter, r *http.Request, userID int64) error {
// 	var body struct {
